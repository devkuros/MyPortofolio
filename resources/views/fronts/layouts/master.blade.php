...
<head>
    ...
    <title>Web Developer || Inbio - Personal Portfolio Bootstrap Template</title>
...
<body class="template-color-1 home-sticky spybody" data-spy="scroll" data-target=".navbar-example2" data-offset="150">
    ...
    <!-- start Header area -->
    <x-layouts.fronts.header></x-layouts.fronts.header>
    ...
    <x-layouts.fronts.popup-mobile></x-layouts.fronts.popup-mobile>
    ...
    <script src="{{asset('front/assets/js/vendor/particles.js')}}"></script>
    <!-- main JS -->

...
<head>
    ...
    <title>Login | MyPortofolio</title>
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class="">Log In to <a href="#"><span class="brand-name">MyPortofolio</span></a></h1>
                        <form class="text-left" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="username" name="username" type="text" class="form-control @error('username') is-invalid @enderror" value="{{ old('username') }}" autofocus placeholder="Username">
                                    @error('username')
                                ...
                                <div id="password-field" class="field-wrapper input mb-2">
                                    ...
                                    <input id="password" autocomplete="current-password" name="password" type="password" class="form-control @error('password') is-invalid @enderror" placeholder="Password">
                                    @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
